...
import com.api.user.dto.LoginRequest;
import com.api.user.dto.RegisterRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> register(@Valid @RequestBody RegisterRequest req) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(Map.of("user", u,"accessToken", patToken));
    }
    ...
    public ResponseEntity<?> login(@Valid @RequestBody LoginRequest req) {
        ...
        String patToken = auth.createPAT(u.getId(), "default", "*");
        return ResponseEntity.ok(Map.of("accessToken", patToken));
    }
